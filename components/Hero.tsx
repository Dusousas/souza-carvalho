...
export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative overflow-hidden bgHero1 text-white py-20 scroll-mt-28 lg:py-30"
    >
      ...
      <div className="relative z-10 maxW flex flex-col gap-20 items-center lg:flex-row">
        <article className="w-full lg:w-[70%]">
          <div className="mb-6 flex items-center gap-4">
            <h3 className="text-Douradop font-display text-sm tracking-[0.34em] uppercase text-center lg:text-left md:text-base">
              Excelência jurídica em todo o Brasil
            </h3>
          </div>

          <h1 className="text-5xl font-semibold text-white text-center lg:text-left md:text-[65px]">
            Defesa estratégica.
            <br />
            Atuação firme.
            <br />
